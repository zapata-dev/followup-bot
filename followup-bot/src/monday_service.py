...
class MondayFollowupService:
    def __init__(self):
        ...
        # Column IDs (configured via env vars)
        self.phone_col_id = os.getenv("MONDAY_PHONE_COLUMN_ID", "phone_seg")
        self.status_col_id = os.getenv("MONDAY_STATUS_COLUMN_ID", "status")
        self.vehicle_col_id = os.getenv("MONDAY_VEHICLE_COLUMN_ID", "text_vehiculo")
        self.template_col_id = os.getenv("MONDAY_TEMPLATE_COLUMN_ID", "long_text_template")
        self.send_date_col_id = os.getenv("MONDAY_SEND_DATE_COLUMN_ID", "date_envio")
        self.reply_date_col_id = os.getenv("MONDAY_REPLY_DATE_COLUMN_ID", "date_respuesta")
        self.last_contact_col_id = os.getenv("MONDAY_LAST_CONTACT_COLUMN_ID", "date_ultimo")
        self.notes_col_id = os.getenv("MONDAY_NOTES_COLUMN_ID", "long_text_notas")
        self.reply_col_id = os.getenv("MONDAY_REPLY_COLUMN_ID", "long_text_respuesta")
        self.dedupe_col_id = os.getenv("MONDAY_DEDUPE_COLUMN_ID", "text_phone_dedupe")
        self.error_col_id = os.getenv("MONDAY_ERROR_COLUMN_ID", "text_error")
        self.resumen_col_id = os.getenv("MONDAY_RESUMEN_COLUMN_ID", "long_text_resumen")
